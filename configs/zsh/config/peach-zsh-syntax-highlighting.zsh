...
## Punctuation
ZSH_HIGHLIGHT_STYLES[commandseparator]='fg=#CC2C58'
...
ZSH_HIGHLIGHT_STYLES[back-quoted-argument-delimiter]='fg=#CC2C58'
ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]='fg=#CC2C58'
ZSH_HIGHLIGHT_STYLES[back-dollar-quoted-argument]='fg=#CC2C58'
...
ZSH_HIGHLIGHT_STYLES[single-quoted-argument-unclosed]='fg=#CC2C58'
ZSH_HIGHLIGHT_STYLES[double-quoted-argument]='fg=#8A7400'
ZSH_HIGHLIGHT_STYLES[double-quoted-argument-unclosed]='fg=#CC2C58'
ZSH_HIGHLIGHT_STYLES[rc-quote]='fg=#8A7400'
## Variables
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]='fg=#5B5B5B'
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument-unclosed]='fg=#CC2C58'
...
ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#CC2C58'
ZSH_HIGHLIGHT_STYLES[path]='fg=#5B5B5B,underline'
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#CC2C58,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#5B5B5B,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix_pathseparator]='fg=#CC2C58,underline'
...
ZSH_HIGHLIGHT_STYLES[back-quoted-argument-unclosed]='fg=#CC2C58'
