...
#
# Installation: ../../.asdf/installs/nodejs/16.18.0/bin/gt completion >> ~/.zshrc
#    or ../../.asdf/installs/nodejs/16.18.0/bin/gt completion >> ~/.zprofile on OSX.
#
_gt_yargs_completions()
{
  ...
  local si=$IFS
  IFS=$'
' reply=($(COMP_CWORD="$((CURRENT-1))" COMP_LINE="$BUFFER" COMP_POINT="$CURSOR" ../../.asdf/installs/nodejs/16.18.0/bin/gt --get-yargs-completions "${words[@]}"))
  IFS=$si
